define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'activity/activity/index' + location.search,
                    ...
                    import_url: 'activity/activity/import',
                    table: 'activity',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'activity/activity/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
