define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'report/agent_daily_report/index' + location.search,
                    add_url: 'report/agent_daily_report/add',
                    edit_url: 'report/agent_daily_report/edit',
                    del_url: 'report/agent_daily_report/del',
                    multi_url: 'report/agent_daily_report/multi',
                    import_url: 'report/agent_daily_report/import',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'register_num', title: __('Register_num')},
                        {field: 'recharge_user_num', title: __('Recharge_user_num')},
                        {field: 'recharge_order_num', title: __('Recharge_order_num')},
                        {field: 'recharge_amount', title: __('Recharge_amount'), operate:'BETWEEN'},
                        {field: 'withdraw_user_num', title: __('Withdraw_user_num')},
                        {field: 'withdraw_order_num', title: __('Withdraw_order_num')},
