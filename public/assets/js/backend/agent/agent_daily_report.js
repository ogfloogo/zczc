define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'agent/agent_daily_report/index' + location.search,
                    add_url: 'agent/agent_daily_report/add',
                    edit_url: 'agent/agent_daily_report/edit',
                    del_url: 'agent/agent_daily_report/del',
                    multi_url: 'agent/agent_daily_report/multi',
                    import_url: 'agent/agent_daily_report/import',
