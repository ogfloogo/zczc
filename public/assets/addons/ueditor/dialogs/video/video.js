    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            var _this = this,
                ...
                acceptExtensions = (editor.getOpt('videoAllowFiles') || [".flv", ".swf", ".mkv", ".avi", ".rm", ".rmvb", ".mpeg", ".mpg", ".ogg", ".ogv", ".mov", ".wmv", ".mp4", ".webm", ".mp3", ".wav", ".mid"]).join('').replace(/\./g, ',').replace(/^[,]/, '');;
