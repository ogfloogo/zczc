...
class VipActivity extends BaseModel
{
    protected function initialize()
    {
        parent::initialize();
        $prefix_config = Config::get('activity.redis_key_prefix')['vip_activity'];
    ...
    public function info($id, $user_info = '')
    {
        ...
        if ($detail_info) {
            ...
            $info['prize_info'] = (new UserActivityPrize())->getUserPrizeInfo($this->activity_id, $user_info, $info['task_info']['user_task_id'], $info['task_info']['status'], $task_info, $prize_info);
        }
