 ...
 * @icon fa fa-circle-o
 */
class ActivityTask extends Backend
{

    /**
     * ActivityTask模型对象
     * @var \app\admin\model\activity\ActivityTask
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\activity\ActivityTask;
        $this->view->assign("typeList", $this->model->getTypeList());
        $this->view->assign("dateTypeList", $this->model->getDateTypeList());
        $this->view->assign("isAutoGetList", $this->model->getIsAutoGetList());
        $this->view->assign("isAutoPrizeList", $this->model->getIsAutoPrizeList());
