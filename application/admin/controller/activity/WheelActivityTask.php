 ...
 * @icon fa fa-circle-o
 */
class WheelActivityTask extends Backend
{

    /**
     * WheelActivityTask模型对象
     * @var \app\admin\model\activity\WheelActivityTask
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\activity\WheelActivityTask;
