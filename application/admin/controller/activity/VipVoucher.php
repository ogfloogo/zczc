 ...
 * @icon fa fa-circle-o
 */
class VipVoucher extends Backend
{

    /**
     * VipVoucher模型对象
     * @var \app\admin\model\activity\VipVoucher
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\activity\VipVoucher;
    ...
    public function index()
    {
        ...
        $list = $this->model
            ->with('userlevel,buyerlevel,activity')
            ->where($where)
            ->order($sort, $order)
            ->paginate($limit);
