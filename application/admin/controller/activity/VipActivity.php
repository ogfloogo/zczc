...
class VipActivity extends Backend
{
    ...
    /**
     * VipActivity模型对象
     * @var \app\admin\model\activity\VipActivity
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\activity\VipActivity;
    ...
    public function add()
    {
        ...
        try {
            ...
            $this->model->setSortedSetCache($this->model->id, $params, intval($params['level']), $params['weigh']);
    ...
    public function edit($ids = null)
    {
        ...
        try {
            ...
            $this->model->setSortedSetCache($ids, $params, intval($params['level']), $params['weigh']);
        } catch (ValidateException | PDOException | Exception $e) {
            Db::rollback();
            $this->error($e->getMessage());
        }
    ...
    public function del($ids = null)
    {
        ...
        try {
            foreach ($list as $item) {
                ...
                $this->model->setSortedSetCache($item->id, [], intval($item->level), 0, true);
            }
            Db::commit();
