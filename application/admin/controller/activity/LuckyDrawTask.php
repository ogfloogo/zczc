 ...
 * @icon fa fa-circle-o
 */
class LuckyDrawTask extends Backend
{

    /**
     * LuckyDrawTask模型对象
     * @var \app\admin\model\activity\LuckyDrawTask
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\activity\LuckyDrawTask;
    ...
    public function add()
    {
        ...
        try {
            ...
            $this->model->setSortedSetCache($this->model->id, $params, 'list', $params['weigh']);
    ...
    public function edit($ids = null)
    {
        ...
        try {
            ...
            $this->model->setSortedSetCache($ids, $params, 'list', $params['weigh']);
        } catch (ValidateException | PDOException | Exception $e) {
            Db::rollback();
            $this->error($e->getMessage());
        }
    ...
    public function del($ids = null)
    {
        ...
        try {
            foreach ($list as $item) {
                ...
                $this->model->setSortedSetCache($item->id, [], 'list', 0, true);
            }
            Db::commit();
