 ...
 * @icon fa fa-circle-o
 */
class WheelActivityPrize extends Backend
{

    /**
     * WheelActivityPrize模型对象
     * @var \app\admin\model\activity\WheelActivityPrize
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\activity\WheelActivityPrize;
    ...
    public function add()
    {
        ...
        try {
            ...
            $this->model->setSortedSetCache($this->model->id, $params, 0, $params['level']);
    ...
    public function edit($ids = null)
    {
        ...
        try {
            ...
            $this->model->setSortedSetCache($ids, $params, 0, $params['level']);
