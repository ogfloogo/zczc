...
use app\admin\model\activity\ActivityCoupon as ActivityActivityCoupon;
 ...
 * @icon fa fa-circle-o
 */
class ActivityCoupon extends Backend
{

    /**
     * ActivityCoupon模型对象
     * @var \app\admin\model\activity\ActivityCoupon
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\activity\ActivityCoupon;
