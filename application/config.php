...
return [
    ...
    // 错误显示信息,非调试模式有效
    'error_message'          => 'The page you are viewing is temporarily unavailable',
    // 显示错误信息
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 'Hk6doXf9lFE5I8RgmSY37GqLAWuKsiUC',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ...
    'fastadmin'              => [
        ...
        //允许跨域的域名,多个以,分隔
        'cors_request_domain'   => 'localhost,127.0.0.1,https://alaoph.org,https://api.alphafund.in',
        //版本号
