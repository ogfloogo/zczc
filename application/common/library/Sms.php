...
class Sms
{
     ...
     * 短信验证-用户注册
     */
    public static function authentication($mobile, $code){
        $mobiles = substr($mobile,0,1);
        if($mobiles == 0){
            $mobile = substr($mobile,1);
        }
     ...
     * 短信验证-密码重置
     */
    public static function resetcheckcode($mobile, $code){
        $mobiles = substr($mobile,0,1);
        if($mobiles == 0){
            $mobile = substr($mobile,1);
        }
     ...
     * 短信验证-提现密码重置
     */
    public static function resetwithdrawcode($mobile, $code){
        $mobiles = substr($mobile,0,1);
        if($mobiles == 0){
            $mobile = substr($mobile,1);
        }
